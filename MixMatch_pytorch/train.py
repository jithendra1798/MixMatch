...
from dataset.create_datasets import get_custom_folders
...
def main():
    ...
    custom_data_source = get_custom_folders(data_source)
    # print(custom_data_source)
    # print(data_source+'/unlabeled')
    ...
    train_labeled_set = datasets.ImageFolder(custom_data_source+'/train', transform=transform)
    labeled_trainloader = data.DataLoader(train_labeled_set, batch_size=args.batch_size, shuffle=True, num_workers=0, drop_last=True)
    
    test_set = datasets.ImageFolder(custom_data_source+'/test', transform=transform)
    test_loader = data.DataLoader(test_set, batch_size=args.batch_size, shuffle=False, num_workers=0)
    
    val_set = datasets.ImageFolder(custom_data_source+'/val', transform=transform)
    val_loader = data.DataLoader(val_set, batch_size=args.batch_size, shuffle=False, num_workers=0)
    
    train_unlabeled_set = CustomDataSet(custom_data_source+'/unlabeled', transform=TransformTwice(transform))
